...
function WaitlistForm() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-midnight-slate via-core-blue to-midnight-slate">
        <div className="text-center max-w-xl">
          ...
          <Link
            href="/"
            className="inline-block px-6 py-3 bg-white text-midnight-slate font-medium rounded-lg hover:bg-white/90 transition-colors"
          >
            Back to Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-br from-midnight-slate via-core-blue to-midnight-slate relative overflow-hidden">
      {/* Subtle gradient orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-electric-azure/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 text-center max-w-2xl w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto mb-16">
          <input
            ...
            required
            className="flex-1 px-5 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-electric-azure/50 transition-colors"
          />
          <button
            type="submit"
...
function WaitlistLoading() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-midnight-slate via-core-blue to-midnight-slate">
