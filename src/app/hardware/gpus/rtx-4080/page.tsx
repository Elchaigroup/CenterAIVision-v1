...
const specifications = [
  ...
  { label: 'FP32 Performance', value: '48.7 TFLOPS' },
  { label: 'RT Core Performance', value: '113 TFLOPS' },
  { label: 'Tensor Performance', value: '780 TFLOPS' },
  { label: 'Max TDP', value: '320W' },
  { label: 'Form Factor', value: 'Triple Slot PCIe' },
]

const performanceMetrics = [
  { value: '16', label: 'GB GDDR6X', description: 'GPU memory' },
  { value: '48.7', label: 'TFLOPS FP32', description: 'Compute power' },
  { value: '9,728', label: 'CUDA Cores', description: 'Parallel processing' },
  { value: '717', label: 'GB/s', description: 'Memory bandwidth' },
]

const keyFeatures = [
  {
    title: 'Ada Lovelace Architecture',
    description: 'High-performance GPU architecture delivering excellent gaming, content creation, and AI capabilities.',
    icon: (
  ...
  {
    title: '16 GB GDDR6X Memory',
    description: 'Ample memory for AI inference, content creation, and running medium-sized language models.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'DLSS 3 Technology',
    description: 'AI-powered Frame Generation for dramatically improved performance with stunning visuals.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Outstanding performance-per-dollar for AI development, inference, and creative workloads.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function RTX4080Page() {
  return (
    <>
      {/* Hero Section */}
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  High-performance gaming and AI GPU. 16 GB GDDR6X memory
                  with excellent efficiency and outstanding value.
                </p>
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-card-bg to-card-bg/50 rounded-2xl border border-green-500/20 overflow-hidden">
                  ...
                  <div className="relative aspect-[4/3] w-full">
                    <Image
                      src="https://d2vfia6k6wrouk.cloudfront.net/productimages/8e5986fc-f795-444c-be17-af3800a0b623/images/pny-rtx-4080-16gb-verto-triple-fan-ra.png"
                  ...
                  <div className="p-4 text-center border-t border-white/5">
                    <p className="text-sm text-cloud-mist/60">16 GB GDDR6X | 48.7 TFLOPS | Ada Lovelace</p>
                  </div>
                </div>
              </div>
            </FadeIn>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-3xl mx-auto text-lg">
                The NVIDIA GeForce RTX 4080 offers exceptional AI and creative performance
                at a more accessible price point than the flagship RTX 4090.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-2xl mx-auto">
                Complete specifications for the NVIDIA GeForce RTX 4080.
              </p>
            </div>
          </Reveal>
