...
const specifications = [
  { label: 'GPUs', value: '8x NVIDIA H100 SXM5' },
  { label: 'Total GPU Memory', value: '640 GB HBM3' },
  { label: 'GPU Memory Bandwidth', value: '26.8 TB/s aggregate' },
...
const performanceMetrics = [
  { value: '8', label: 'H100 GPUs', description: 'Fully connected' },
  { value: '640', label: 'GB HBM3', description: 'Total GPU memory' },
  { value: '32', label: 'PFLOPS FP8', description: 'AI performance' },
  { value: '3.6', label: 'TB/s NVSwitch', description: 'GPU interconnect' },
]

const keyFeatures = [
  {
    title: '8x H100 SXM5 GPUs',
    description: 'Eight fully-connected H100 GPUs with NVSwitch fabric for maximum multi-GPU performance on any AI workload.',
    icon: (
  ...
  {
    title: 'Turnkey AI System',
    description: 'Pre-integrated system with optimized software stack, ready to deploy for AI training and inference.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'NVSwitch Fabric',
    description: '3.6 TB/s bisection bandwidth enables all 8 GPUs to communicate at full NVLink speed simultaneously.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: '400G InfiniBand',
    description: 'Eight 400 Gb/s InfiniBand ports for high-speed multi-node scaling in large AI clusters.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function DGXH100Page() {
  return (
    <>
      {/* Hero Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-cloud-mist leading-tight mb-4">
                  NVIDIA
                  <span className="block bg-gradient-to-r from-blue-400 via-indigo-500 to-violet-400 bg-clip-text text-transparent">
                    DGX H100
                  </span>
                </h1>

                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  The ultimate AI supercomputer. 8x H100 GPUs with NVSwitch fabric
                  delivering 32 petaFLOPS of AI performance in a single system.
                </p>

                <div className="flex flex-wrap gap-4">
                  <Link href="/waitlist?product=NVIDIA DGX H100">
            ...
            <FadeIn delay={200}>
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/30 to-indigo-500/30 rounded-3xl blur-2xl opacity-50" />
                <div className="relative bg-gradient-to-br from-card-bg to-card-bg/50 rounded-2xl border border-blue-500/20 overflow-hidden">
                  ...
                  <div className="relative aspect-[4/3] w-full">
                    <Image
                      src="/images/nvidia-dgx-h100.png"
                      alt="NVIDIA DGX H100"
                      fill
                  ...
                  <div className="p-4 text-center border-t border-white/5">
                    <p className="text-sm text-cloud-mist/60">8x H100 | 640 GB | 32 PFLOPS</p>
                  </div>
                </div>
              </div>
            </FadeIn>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-3xl mx-auto text-lg">
                The NVIDIA DGX H100 is the foundation for enterprise AI infrastructure,
                delivering unprecedented performance for the most demanding AI workloads.
              </p>
            </div>
          </Reveal>
              ...
              <FadeIn key={feature.title} delay={index * 100}>
                <Card variant="glass" className="h-full" spotlight={false}>
                  <CardContent className="flex gap-4">
                    <div className="p-3 rounded-xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 text-blue-400 h-fit">
                      {feature.icon}
                    </div>
                    <div>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-2xl mx-auto">
                Complete specifications for the NVIDIA DGX H100.
              </p>
            </div>
          </Reveal>
