...
const specifications = [
  { label: 'GPU Count', value: '8x NVIDIA Blackwell GPUs' },
  { label: 'GPU Memory', value: '1,440 GB HBM3e' },
  { label: 'GPU Memory Bandwidth', value: '64 TB/s' },
  { label: 'FP4 Tensor Core', value: '144 PFLOPS' },
  { label: 'FP8 Tensor Core', value: '72 PFLOPS' },
  { label: 'NVLink Bandwidth', value: '14.4 TB/s aggregate' },
  { label: 'CPU', value: '2x Intel Xeon Platinum 8570' },
  { label: 'CPU Cores', value: '112 total cores' },
  { label: 'System Memory', value: '2 TB (up to 4 TB)' },
  { label: 'Storage', value: '8x 3.84 TB NVMe' },
  { label: 'Networking', value: '4x 400 Gb/s OSFP' },
  { label: 'Form Factor', value: '10 RU' },
  { label: 'Power', value: '~14.3 kW max' },
]

const performanceMetrics = [
  { value: '3x', label: 'Training Performance', description: 'vs previous gen' },
  { value: '15x', label: 'Inference Performance', description: 'vs DGX H100' },
  { value: '144', label: 'PFLOPS FP4', description: 'Tensor Core compute' },
  { value: '1.4 TB', label: 'GPU Memory', description: 'HBM3e total' },
]

const keyFeatures = [
  {
    title: '8 Blackwell GPUs',
    description: 'Eight NVIDIA Blackwell GPUs interconnected with fifth-generation NVLink for unified AI training and inference.',
    icon: (
  ...
  },
  {
    ...
    description: 'Purpose-built for all AI workloads from analytics to training to inference in a single unified system.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: '14.4 TB/s NVLink',
    description: 'Dual NVSwitch provides massive aggregate NVLink bandwidth for seamless GPU-to-GPU communication.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Complete NVIDIA AI software stack pre-installed with optimized Ubuntu server distribution.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function B200ClusterPage() {
  return (
    <>
      {/* Hero Section */}
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  The foundation for your AI factory. A unified platform for training, fine-tuning,
                  and inference powered by 8 NVIDIA Blackwell GPUs with 1.4TB of GPU memory.
                </p>
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-card-bg to-card-bg/50 rounded-2xl border border-electric-azure/20 overflow-hidden">
                  ...
                  <div className="relative aspect-[4/3] w-full">
                    <Image
                      src="https://d2vfia6k6wrouk.cloudfront.net/productimages/6e8c9ba9-7167-48a0-be6d-b16c00914fe0/images/nvidia-dgx-b200.png"
                      alt="NVIDIA DGX B200 Server"
                      fill
                  ...
                  <div className="p-4 text-center border-t border-white/5">
                    <p className="text-sm text-cloud-mist/60">8 GPUs | 144 PFLOPS | 10 RU</p>
                  </div>
                </div>
              </div>
            </FadeIn>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-cloud-mist mb-4">
                Your AI Factory Foundation
              </h2>
              <p className="text-cloud-mist/60 max-w-3xl mx-auto text-lg">
                The DGX B200 sets a new bar for compute density, packing 144 petaFLOPS of AI
                performance into a compact 10U form factor. Handle large language models,
                recommender systems, and real-time AI inference with ease.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-2xl mx-auto">
                Enterprise-grade specifications for the most demanding AI workloads.
              </p>
            </div>
          </Reveal>
