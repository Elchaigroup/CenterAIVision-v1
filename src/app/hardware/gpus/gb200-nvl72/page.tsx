...
const specifications = [
  { label: 'GPU Count', value: '72 Blackwell GPUs' },
  { label: 'CPU Count', value: '36 Grace CPUs' },
  { label: 'GPU Memory', value: '13.4 TB HBM3e' },
...
const performanceMetrics = [
  { value: '30x', label: 'LLM Inference', description: 'faster than H100' },
  { value: '4x', label: 'LLM Training', description: 'vs H100 GPU' },
  { value: '25x', label: 'Energy Efficiency', description: 'perf-per-watt vs H100' },
  { value: '18x', label: 'Data Processing', description: 'database acceleration' },
]

const keyFeatures = [
  {
    title: '72 Blackwell GPUs',
    description: 'Connected with fifth-generation NVLink technology for unprecedented AI compute power in a single rack-scale system.',
    icon: (
  ...
  {
    title: '36 Grace CPUs',
    description: 'Arm Neoverse V2 based processors with 2,592 total cores providing massive parallel processing capability.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Liquid-Cooled Design',
    description: 'Advanced liquid cooling enables maximum performance density while achieving 25x better energy efficiency.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: '130 TB/s NVLink',
    description: 'Fifth-generation NVLink Switch System provides massive GPU-to-GPU communication bandwidth.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  A rack-scale, liquid-cooled system designed for scalable LLM inference and
                  advanced AI data center needs. 72 Blackwell GPUs with 36 Grace CPUs deliver
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-card-bg to-card-bg/50 rounded-2xl border border-electric-azure/20 overflow-hidden">
                  ...
                  <div className="relative aspect-[4/3] w-full">
                    <Image
                      src="https://www.ingrasys.com/upload/fac_b/solution_gb200nvl71_highlight__24K26MLFnl.png"
                      alt="NVIDIA GB200 NVL72 Server Rack"
                      fill
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-3xl mx-auto text-lg">
                The GB200 NVL72 delivers real-time trillion-parameter model inference,
                making it the ideal platform for enterprise AI deployments requiring
                massive scale and exceptional energy efficiency.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-2xl mx-auto">
                Industry-leading specifications for scalable LLM inference and AI workloads.
              </p>
            </div>
          </Reveal>
