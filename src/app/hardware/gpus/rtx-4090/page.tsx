...
const specifications = [
  ...
  { label: 'FP32 Performance', value: '82.6 TFLOPS' },
  { label: 'RT Core Performance', value: '191 TFLOPS' },
  { label: 'Tensor Performance', value: '1,321 TFLOPS' },
  { label: 'Max TDP', value: '450W' },
  { label: 'Form Factor', value: 'Triple Slot PCIe' },
]

const performanceMetrics = [
  { value: '24', label: 'GB GDDR6X', description: 'GPU memory' },
  { value: '82.6', label: 'TFLOPS FP32', description: 'Compute power' },
...
const keyFeatures = [
  {
    ...
    description: 'The most powerful consumer GPU architecture with breakthrough performance for gaming, content creation, and AI.',
    icon: (
  ...
  {
    title: '24 GB GDDR6X Memory',
    description: 'Massive memory capacity for running large AI models, high-resolution content creation, and demanding workloads.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'AI-powered Frame Generation delivers up to 4x performance boost with exceptional image quality.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Excellent price-to-performance ratio for AI inference, fine-tuning, and development workloads.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function RTX4090Page() {
  return (
    <>
      {/* Hero Section */}
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  The ultimate GeForce GPU. 24 GB of blazing-fast GDDR6X memory
                  with 16,384 CUDA cores for unmatched performance.
                </p>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-3xl mx-auto text-lg">
                The NVIDIA GeForce RTX 4090 delivers exceptional performance for AI workloads,
                content creation, and gaming at an accessible price point.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-cloud-mist/60 max-w-2xl mx-auto">
                Complete specifications for the NVIDIA GeForce RTX 4090.
              </p>
            </div>
          </Reveal>
