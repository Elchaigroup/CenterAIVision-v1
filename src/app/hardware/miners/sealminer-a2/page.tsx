...
const specifications = [
  ...
  { label: 'Power Consumption', value: '3,420W' },
  { label: 'Energy Efficiency', value: '15.1 J/TH' },
  { label: 'Algorithm', value: 'SHA-256' },
  { label: 'Cooling', value: 'Air Cooled' },
  { label: 'Dimensions', value: '420 x 180 x 290 mm' },
...
const keyFeatures = [
  {
    title: 'New SHA-256 ASIC from Bitdeer',
    description: 'Bitdeer latest entry into ASIC manufacturing, bringing fresh competition to the Bitcoin mining hardware market.',
    icon: (
  ...
  {
    title: 'Competitive Efficiency',
    description: 'At 15.1 J/TH, the Sealminer A2 offers competitive efficiency comparable to established manufacturers.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function SealminerA2Page() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-28 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-rose-600/20 via-midnight-slate to-midnight-slate" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeIn delay={200}>
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-rose-500/30 to-pink-500/30 rounded-3xl blur-2xl opacity-50" />
                <div className="relative bg-gradient-to-br from-card-bg to-card-bg/50 rounded-2xl border border-rose-500/20 overflow-hidden">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-1/2 bg-rose-500/20 blur-3xl" />

                  <div className="relative aspect-[4/3] w-full">
                    <Image
                      src="https://bitmars.io/wp-content/uploads/2025/05/Bitdeer-SealMiner-A2-Bitcoin-Miner-226THS-BT-MINERS.png"
                  ...
                  <div className="p-4 text-center border-t border-white/5">
                    <p className="text-sm text-cloud-mist/60">226 TH/s | 15.1 J/TH | Air Cooled</p>
                  </div>
                </div>
              </div>
            </FadeIn>
      ...
      {/* Performance Metrics */}
      <section className="py-12 border-y border-rose-500/10 bg-card-bg/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {performanceMetrics.map((metric, index) => (
              <FadeIn key={metric.label} delay={index * 100}>
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-rose-400 to-pink-400 bg-clip-text text-transparent">
                    {metric.value}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="text-center mb-16">
              <span className="inline-block px-4 py-1.5 mb-4 text-sm font-medium text-rose-400 bg-rose-500/10 rounded-full border border-rose-500/20">
                Center AI Vision
              </span>
              ...
              <FadeIn key={feature.title} delay={index * 100}>
                <Card variant="glass" className="h-full" spotlight={false}>
                  <CardContent className="flex gap-4">
                    <div className="p-3 rounded-xl bg-gradient-to-br from-rose-500/20 to-pink-500/20 text-rose-400 h-fit">
                      {feature.icon}
                    </div>
                    <div>
