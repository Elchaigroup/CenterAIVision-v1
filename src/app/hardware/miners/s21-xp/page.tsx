...
export default function S21XPPage() {
  return (
    <>
            ...
            <FadeIn>
              <div>
                ...
                <p className="text-xl text-cloud-mist/70 mb-8 leading-relaxed">
                  The most powerful air-cooled Bitcoin miner. Invest in 270 TH/s hashrate with
                  record-setting 13.5 J/TH efficiency - fully hosted and managed.
                </p>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-purple-500/10 via-card-bg/50 to-purple-500/10">
